...
test('for an array of episodes returns an array of episodes stored into seasons', () => {
    const result = formatSeasons(episodeData);
    
    expect(result['Season 1']).toHaveLength(8);
    expect(result['Season 2']).toHaveLength(9);
    expect(result['Season 3']).toHaveLength(8);
})